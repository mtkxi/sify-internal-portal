...
export function FeasibilityManagement() {
  ...
  const mockDrafts: DraftItem[] = [
    {
      ...
      service: "MPLS" as const,
      linkType: "Hub & Spoke" as const,
    },
    {
      id: "DRAFT-002",
      ...
      connections: 2,
      company: "TechCorp Solutions",
      submissionType: "Bulk Upload" as const,
      service: "DIA" as const,
      linkType: "Mesh" as const,
    },
    {
      id: "DRAFT-003",
  ...
  const mockFeasibilityPool = [
    ...
    },
    {
      ...
      feasibilityStatus: "Feasible" as const,
      expiresOn: "2025-03-15",
      orderStatus: "Proposal Generated" as const,
      isSelectable: true,
      nearingExpiry: false,
      company: "TechCorp Solutions",
      service: "MPLS" as const,
    ...
    // TechCorp Solutions - MPLS - OPP-2025-005 (Checking Feasibility)
    {
      ...
      connectionType: "Fiber",
      bandwidth: "500 Mbps",
      feasibilityStatus: "Checking Feasibility" as const,
      isSelectable: true,
      nearingExpiry: false,
      company: "TechCorp Solutions",
      service: "MPLS" as const,
    ...
    // TechCorp Solutions - DIA - OPP-2025-006 (Not Feasible)
    {
      ...
      bandwidth: "50 Mbps",
      feasibilityStatus: "Not Feasible" as const,
      isSelectable: false,
      nearingExpiry: false,
      company: "TechCorp Solutions",
      service: "DIA" as const,
    ...
    // TechCorp Solutions - DIA - OPP-2024-089 (Expired)
    {
      ...
      connectionType: "Wireless",
      bandwidth: "30 Mbps",
      feasibilityStatus: "Expired" as const,
      expiresOn: "2025-01-25",
      orderStatus: "Order Completed" as const,
      isSelectable: false,
      nearingExpiry: false,
      company: "TechCorp Solutions",
      service: "DIA" as const,
    ...
    // TechCorp Solutions - P2P - GCC - OPP-2025-020 (Cloud Provider End)
    {
      ...
      service: "DIA" as const,
      linkType: "Hub & Spoke" as const,
      locationCategory: "Cloud Provider" as const,
    },
    // TechCorp Solutions - P2P - GCC - OPP-2025-020 (Data Center End)
    {
      ...
      service: "DIA" as const,
      linkType: "Hub & Spoke" as const,
      locationCategory: "Data Center" as const,
    },
    ...
    // TechCorp Solutions - P2P - GCC - OPP-2025-021 (Office Branch End)
    {
      ...
      service: "DIA" as const,
      linkType: "Mesh" as const,
      locationCategory: "Office Branch" as const,
    },
                      ...
                      {feasibilityFilterOptions.serviceChangeTypes.map((changeType, idx) => (
                        <div key={`change-type-${idx}-${changeType}`} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked: boolean) => handleFilterChange('serviceChangeTypes', changeType, checked)}
                          />
                        ...
                        .map((bandwidth, idx) => (
                          <div key={`bandwidth-${idx}-${bandwidth}`} className="flex items-center space-x-2 p-1 hover:bg-gray-50 rounded">
                            <Checkbox
                              ...
                              onCheckedChange={(checked: boolean) => handleFilterChange('bandwidths', bandwidth, checked)}
                            />
                    ...
                    {feasibilityFilterOptions.feasibilityStatuses.map((status, idx) => (
                      <div key={`feas-status-${idx}-${status}`} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => handleFilterChange('feasibilityStatuses', status, checked)}
                        />
                    ...
                    {requirementsFilterOptions.services.map((service, idx) => (
                      <div key={`service-${idx}-${service}`} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => handleFilterChange('services', service, checked)}
                        />
                    ...
                    {requirementsFilterOptions.statuses.map((status, idx) => (
                      <div key={`req-status-${idx}-${status}`} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => handleFilterChange('statuses', status, checked)}
                        />
                    ...
                    {requirementsFilterOptions.contractTerms.map((term, idx) => (
                      <div key={`term-${idx}-${term}`} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => handleFilterChange('contractTerms', term, checked)}
                        />
                    ...
                    {draftsFilterOptions.submissionTypes.map((type, idx) => (
                      <div key={`submission-${idx}-${type}`} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked: boolean) => handleFilterChange('submissionTypes', type, checked)}
                        />
